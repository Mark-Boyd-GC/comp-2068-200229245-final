  ...
  return (
    <Switch>
      ...
      {/*
          ...
          ANSWER HERE: 
          If logged in as a user, render the tours/new tour/edit tour page (depending on what was clicked).
          If they are not a user, redirect them to the root of the application.
        */}
      <Route
        exact
        path='/tours'
